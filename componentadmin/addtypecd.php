...
<head>
    ...
    <title>เพิ่มข้อมูล ประเภท CD-DVD</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="../style/maineverypage.css">
    <link rel="stylesheet" href="../style/homeadmin.css">
    <script>
    // function send() {
    //     alert("เพิ่มข้อมูล ประเภท CD-DVD เรียบร้อยแล้ว");
    //     let a = document.getElementById("รหัสประเภท_CD_DVD").value
    //     let b = document.getElementById("ชื่อประเภท_CD_DVD").value
    //     console.log(a);
    //     console.log(b);
    //     document.location = "./add/typecdtodb.php?a=" + a + "&b=" + b;
    // }
...
<body>
    ...
    <div class="texts">เพิ่มข้อมูล ประเภท CD-DVD</div>
    <div class="form">
        <form action="./add/typecdtodb.php" method="get">
            <p>รหัส ประเภท CD-DVD : <input type="text" name="รหัสประเภท_CD_DVD" id="รหัสประเภท_CD_DVD" required></p>
            <p>ชื่อ ประเภท CD-DVD : <input type="text" name="ชื่อประเภท_CD_DVD" id="ชื่อประเภท_CD_DVD" required></p>
            <br><br>
