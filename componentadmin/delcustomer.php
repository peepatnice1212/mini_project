...
<head>
    ...
    <title>ลบข้อมูล ลูกค้า</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="../style/maineverypage.css">
    <link rel="stylesheet" href="../style/homeadmin.css">
    <script>
    // function send() {
    //     alert("ลบข้อมูล ลูกค้า เรียบร้อยแล้ว");
    //     let a = document.getElementById("Username_สมาชิก").value
    //     document.location = "./delete/customerfromdb.php?a=" + a;
    // }
...
<body>
    ...
    <div class="texts">ลบข้อมูล ลูกค้า</div>
    <div class="form">
        <form action="./delete/customerfromdb.php" method="get">
            <p>รหัส สมาชิก : <input type="text" name="รหัส_สมาชิก" id="รหัส_สมาชิก" required></p><br><br>
