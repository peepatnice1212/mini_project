...
<head>
    ...
    <title>ลบข้อมูล CD-DVD</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="../style/maineverypage.css">
    <link rel="stylesheet" href="../style/homeadmin.css">
    <script>
    // function send() {
    //     alert("ลบข้อมูล CD-DVD เรียบร้อยแล้ว");
    //     let a = document.getElementById("ชื่อ_CD_DVD").value
    //     document.location = "./delete/cdfromdb.php?a=" + a;
    // }
...
<body>
    ...
    <div class="texts">ลบข้อมูล CD-DVD</div>
    <div class="form">
        <form action="./delete/cdfromdb.php" method="get">
            <p>ชื่อ CD-DVD : <input type="text" name="ชื่อ_CD_DVD" id="ชื่อ_CD_DVD" required></p><br><br>
