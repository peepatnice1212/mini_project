...
<body>
    ...
    <div class="texts">ข้อมูล Admin</div>
    ...
    <table class="center">
        <tr>
            ...
            <th>ชื่อ-สกุล Admin</th>
            <th>เบอร์โทร Admin</th>
        </tr>
    ...
    while($row = $stmt->fetch()) : ?>
        <tr>
            ...
            <th><?=$row["Username_Admin"]?></th>
            <th><?=$row["Password_Admin"]?></th>
            <th><?=$row["ชื่อ_สกุล_Admin"]?></th>
            <th><?=$row["เบอร์โทร_Admin"]?></th>
        </tr>
        <?php endwhile ?>
    </table>
    <!-- </div> -->
