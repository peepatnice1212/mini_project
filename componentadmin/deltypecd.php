...
<head>
    ...
    <title>ลบข้อมูล ประเภท CD-DVD</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="../style/maineverypage.css">
    <link rel="stylesheet" href="../style/homeadmin.css">
    <script>
    // function send() {
    //     alert("ลบข้อมูล ประเภท CD-DVD เรียบร้อยแล้ว");
    //     let a = document.getElementById("ชื่อประเภท_CD_DVD").value
    //     document.location = "./delete/typecdfromdb.php?a=" + a;
    // }
...
<body>
    ...
    <div class="texts">ลบข้อมูล ประเภท CD-DVD</div>
    <div class="form">
        <form action="./delete/typecdfromdb.php" method="get">
